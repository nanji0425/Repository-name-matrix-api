...
export function getLobeIcon(
  ...
  if (isImageIconSource(trimmedName)) {
    return (
      <img
        src={trimmedName}
        alt=''
...
export function isImageIconSource(value: string | undefined | null): boolean {
  if (!value || typeof value !== 'string') return false
  return /^(?:https?:\/\/|data:image\/|\/model-icons\/)/i.test(value.trim())
}

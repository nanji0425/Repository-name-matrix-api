...
export function SystemBrand(props: SystemBrandProps) {
  ...
  const name = status?.system_name || props.defaultName || 'Matrix API'
  const version =
    ...
    <SidebarMenu>
      <SidebarMenuItem>
        <SidebarMenuButton
          ...
          render={<div />}
        >
          <div className='flex aspect-square size-[51px] items-center justify-center overflow-hidden rounded-lg'>
            <img
              src={logo}
              alt={t('Logo')}

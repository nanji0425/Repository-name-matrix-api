...
func parseModelQueryFlag(value string) *int {
...
func modelQueryFilter(c *gin.Context) model.ModelQueryFilter {
	return model.ModelQueryFilter{
		Status:       parseModelQueryFlag(c.Query("status")),
		SyncOfficial: parseModelQueryFlag(c.Query("sync_official")),
	}
}
...
func GetAllModelsMeta(c *gin.Context) {
	...
	modelsMeta, err := model.GetAllModelsWithFilter(pageInfo.GetStartIdx(), pageInfo.GetPageSize(), modelQueryFilter(c))
	if err != nil {
...
func SearchModelsMeta(c *gin.Context) {
	...
	modelsMeta, total, err := model.SearchModelsWithFilter(keyword, vendor, pageInfo.GetStartIdx(), pageInfo.GetPageSize(), modelQueryFilter(c))
	if err != nil {
		common.ApiError(c, err)
		return
	}

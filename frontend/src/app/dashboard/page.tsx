...
export default function DashboardOverview() {
  ...
  const cards = useMemo(() => [
    ...
    { value: String(stats.totalRequests || 0), label: '统计次数' },
    { value: `¥${Number(stats.totalCost || 0).toFixed(2)}`, label: '统计额度' },
  ...
  return (
    <ConsolePage className="pb-28">
      ...
      <section className="console-card mt-6 h-[222px] p-6">
        ...
        <div className="flex h-[135px] items-center justify-center text-slate-500">暂无数据</div>
      </section>
    </ConsolePage>
  );
}

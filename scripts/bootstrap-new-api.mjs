...
async function ensurePricing(cookie) {
  ...
  await updateOption(cookie, 'Logo', '/matrix-assets/matrixapi-logo.png?v=2026071213')
  await updateOption(cookie, 'general_setting.logo', '/matrix-assets/matrixapi-logo.png?v=2026071213')
